...
export interface Exclusion {
  ...
  why: string;
  /**
   * Match the case *title* exactly rather than any line containing `match`. `terminal-link`
   * has a case titled `stderr` and three more whose titles contain the word (A27).
   */
  exact?: boolean;
}
