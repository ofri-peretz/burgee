...
ora's own 112.7 KB; `flagstaff/log-update` 28.6 KB — 46.7 KB counted the same way, against
log-update's own 113.4 KB. Neither façade reaches the other, and neither reaches the core. `sideEffects: false` lets a
