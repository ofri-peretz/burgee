...
Weight, installed and tree-inclusive: **80,143 bytes** against **30,912** for the incumbents it replaces — a ratio of **2.5926** (terminal-link, term-img not installed here, so the ceiling is understated).
## Where it sits
