...
Weight, installed and tree-inclusive: **66,341 bytes** against **30,912** for the incumbents it replaces — a ratio of **2.1461** (terminal-link, term-img not installed here, so the ceiling is understated).
## Where it sits
