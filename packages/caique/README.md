...
Weight, installed and tree-inclusive: **122,447 bytes** against **182,472** for the incumbents it replaces — a ratio of **0.6710** (@inquirer/core measured but left out of the ceiling, so it is understated).
## Where it sits
