...
Weight, installed and tree-inclusive: **122,646 bytes** against **182,219** for the incumbents it replaces — a ratio of **0.6731** (@inquirer/core not installed here, so the ceiling is understated).
## Where it sits
