...
Weight, installed and tree-inclusive: **114,850 bytes** against **182,219** for the incumbents it replaces — a ratio of **0.6303** (@inquirer/core not installed here, so the ceiling is understated).
## Where it sits
