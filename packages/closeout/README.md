...
Weight, installed and tree-inclusive: **96,356 bytes** against **170,604** for the incumbents it replaces — a ratio of **0.5648** (exit-hook not installed here, so the ceiling is understated).
## Where it sits
