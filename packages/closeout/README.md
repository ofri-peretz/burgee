...
Weight, installed and tree-inclusive: **85,864 bytes** against **170,604** for the incumbents it replaces — a ratio of **0.5033** (exit-hook not installed here, so the ceiling is understated).
## Where it sits
