...
Weight, installed and tree-inclusive: **95,423 bytes** against **170,604** for the incumbents it replaces — a ratio of **0.5593** (exit-hook not installed here, so the ceiling is understated).
## Where it sits
