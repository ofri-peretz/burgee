...
Weight, installed and tree-inclusive: **84,453 bytes** against **170,604** for the incumbents it replaces — a ratio of **0.4950** (exit-hook not installed here, so the ceiling is understated).
## Where it sits
