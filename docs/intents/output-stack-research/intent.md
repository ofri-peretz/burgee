...
`docs/research/output-stack-open-issues.md`: every open issue — and, where a maintainer
...
- `docs/research/output-stack-open-issues.md` (new) and `competitor-landscape.md` (a
