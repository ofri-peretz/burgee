...
| **2 · compatibility** | `commander-compat`, `cli-help-renderer` ↑ | every upstream file graded; `burgee/commander` 1,361/1,361 (= real commander in the same run) and byte-identical to commander on the demo (X7, 29 cases); help rendered from the manifest with `help <cmd>`, groups, examples, env, width from the runtime (H1–H6) | in progress |
