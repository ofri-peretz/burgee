...
Weight, installed and tree-inclusive: **121,829 bytes** against **182,219** for the incumbents it replaces — a ratio of **0.6686** (@inquirer/core not installed here, so the ceiling is understated).
## Where it sits
