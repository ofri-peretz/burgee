 ...
 * icon item with an aria-hidden SVG rather than `githubUrl`, which fumadocs
 * renders as an unlabelled `<svg role="img">` (same a11y fix as eslint docs).
 */
export function baseOptions(): BaseLayoutProps {
  return {
    nav: { title: <BrandLogo />, transparentMode: 'top' },
    links: [
