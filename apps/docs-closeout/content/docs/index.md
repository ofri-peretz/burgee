...
Weight, installed and tree-inclusive: **103,208 bytes** against **170,604** for the incumbents it replaces — a ratio of **0.6050** (exit-hook measured but left out of the ceiling, so it is understated).
## Where it sits
