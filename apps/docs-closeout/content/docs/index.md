...
Weight, installed and tree-inclusive: **103,191 bytes** against **170,604** for the incumbents it replaces — a ratio of **0.6049** (exit-hook measured but left out of the ceiling, so it is understated).
## Where it sits
