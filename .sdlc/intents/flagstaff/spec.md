...
- **R10** Subpath isolation and weight rules per entry; ceilings: `./spinner` ≤ ora,
  ...
  (restated 2026-09-23, D-129; first written *"depends on `roundel` only"*).
