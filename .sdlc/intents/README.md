...
| :-------------------------------------------------------------------------------------------- | :------------------------ | :------------------------------------------------------ |
| the framework                                                                                 | `burgee`                  | ✅ `burgee@0.9.1`                                       |
...
| the colours a CLI carries: policy, tokens, theme, chalk path                                  | `roundel`                 | ✅ `roundel@0.4.1` — chalk path graded 58 / 58          |
...
| measuring and cutting styled text: width, wrap, truncate, slice                               | `linegauge`               | `linegauge@0.4.1` stub; F1                              |
| ending cleanly: exactly-once handlers, a deadline, terminal restore                           | `closeout`                | `closeout@0.3.1` stub; F2                               |
| which source outranks which, and which one set this value                                     | `seniority`               | `seniority@0.4.1` stub; F3                              |
| running another program and getting a result back                                             | `bellpull`                | `bellpull@0.2.1` stub; F4, conditional on its kill gate |
