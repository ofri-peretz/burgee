...
| :-------------------------------------------------------------------------------------------- | :------------------------ | :------------------------------------------------------ |
| the framework                                                                                 | `burgee`                  | ✅ `burgee@0.9.2`                                       |
...
| the staff the flag flies from: frame loop, plugin host, ora/boxen/cli-table3/log-update paths | `flagstaff`               | ✅ `flagstaff@0.3.5`                                    |
| the parrot that always answers back: prompts, flags first                                     | `caique`                  | ✅ `caique@0.4.1`                                       |
| measuring and cutting styled text: width, wrap, truncate, slice                               | `linegauge`               | `linegauge@0.4.2` stub; F1                              |
| ending cleanly: exactly-once handlers, a deadline, terminal restore                           | `closeout`                | `closeout@0.3.2` stub; F2                               |
