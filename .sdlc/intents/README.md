...
| 34  | [`bellpull/`](./bellpull/)                         | **bellpull** — executable resolution and a subprocess _result_ with a static projection; 15 incumbents, 2.29 B/wk; **carries a kill gate on `tinyexec`**                                          | Y3 Y5–Y8 Y10 Y12       | draft                                                                                                                                                                                                                                                                                                                                                  |
...
| 37  | [`schema-is-validated/`](./schema-is-validated/) | **F1** — `--schema` output validates against a schema this package publishes. `schemaVersion: 1` ships; the JSON Schema does not exist, and `JSON-Schema validated` sat on two READMEs until it was struck | F1 F2                  | review                                                                                                                                                                                                                                                                                                                                                 |
