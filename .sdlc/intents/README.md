...
| :-------------------------------------------------------------------------------------------- | :------------------------ | :------------------------------------------------------ |
| the framework                                                                                 | `burgee`                  | ✅ `burgee@0.12.1`                                       |
...
| the colours a CLI carries: policy, tokens, theme, chalk path                                  | `roundel`                 | ✅ `roundel@0.5.2` — chalk path graded 58 / 58          |
| the staff the flag flies from: frame loop, plugin host, ora/boxen/cli-table3/log-update paths | `flagstaff`               | ✅ `flagstaff@0.4.2`                                    |
| the parrot that always answers back: prompts, flags first                                     | `caique`                  | ✅ `caique@0.5.2`                                       |
| measuring and cutting styled text: width, wrap, truncate, slice                               | `linegauge`               | `linegauge@0.5.2` stub; F1                              |
| ending cleanly: exactly-once handlers, a deadline, terminal restore                           | `closeout`                | `closeout@0.5.2` stub; F2                               |
| which source outranks which, and which one set this value                                     | `seniority`               | `seniority@0.6.0` stub; F3                              |
| running another program and getting a result back                                             | `bellpull`                | `bellpull@0.4.0` stub; F4, conditional on its kill gate |
