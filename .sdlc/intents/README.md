...
| One Vercel project, one DNS record and one GitHub Environment **per further docs app**; and the decision on renaming `cli.interlace.tools` → `burgee.interlace.tools` | `docs-per-package` |
