...
| :-------------------------------------------------------------------------------------------- | :------------------------ | :------------------------------------------------------ |
| the framework                                                                                 | `burgee`                  | ✅ `burgee@0.13.0`                                       |
...
| measuring and cutting styled text: width, wrap, truncate, slice                               | `linegauge`               | `linegauge@0.5.3` stub; F1                              |
| ending cleanly: exactly-once handlers, a deadline, terminal restore                           | `closeout`                | `closeout@0.5.2` stub; F2                               |
| which source outranks which, and which one set this value                                     | `seniority`               | `seniority@0.6.1` stub; F3                              |
| running another program and getting a result back                                             | `bellpull`                | `bellpull@0.4.1` stub; F4, conditional on its kill gate |
