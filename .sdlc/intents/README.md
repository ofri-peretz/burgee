...
| ending cleanly: exactly-once handlers, a deadline, terminal restore                           | `closeout`                | `closeout@0.4.2` stub; F2                               |
