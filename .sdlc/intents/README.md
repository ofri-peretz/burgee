...
| :-- | :-- | :-- | :-- |
| ~~**Give `roundel`, `flagstaff` and `caique` a publish credential.**~~ | npm trusted publisher | done | **closed 2026-09-09** — all three published at 0.1.0 (18:14Z) and `release.yml` has run green five times since. This row sat open in the roadmap for a day after it was fixed, which is the reason for the audit above |
