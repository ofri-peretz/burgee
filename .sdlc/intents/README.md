...
| :-------------------------------------------------------------------------------------------- | :------------------------ | :------------------------------------------------------ |
| the framework                                                                                 | `burgee`                  | ✅ `burgee@0.8.0`                                       |
...
| the staff the flag flies from: frame loop, plugin host, ora/boxen/cli-table3/log-update paths | `flagstaff`               | ✅ `flagstaff@0.3.2`                                    |
| the parrot that always answers back: prompts, flags first                                     | `caique`                  | ✅ `caique@0.3.1`                                       |
| measuring and cutting styled text: width, wrap, truncate, slice                               | `linegauge`               | `linegauge@0.3.2` stub; F1                              |
| ending cleanly: exactly-once handlers, a deadline, terminal restore                           | `closeout`                | `closeout@0.2.1` stub; F2                               |
| which source outranks which, and which one set this value                                     | `seniority`               | `seniority@0.3.1` stub; F3                              |
