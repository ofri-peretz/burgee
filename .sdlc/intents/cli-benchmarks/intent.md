...
already promises a cold-start budget, `.sdlc/research/competitor-landscape.md` §5 promises
...
- `.sdlc/bands/control-bands.json` gains `agent-tokens-per-task`, `agent-turns-per-task`,
