...
| A12 | seniority: cosmiconfig 186/243, dotenv **106**/141 (was 80), lilconfig 67/77, rc **1/1** (was 0) — D-131 lifted the two; dotenv's remaining 35 are the declined vault/decrypt (27), dotenvx tips (2), and 6 internal-module cases the harness cannot map yet | compat baselines | each suite at 100%, or each failing case named with its reason |
