...
| ~~C5~~ | ~~the lint half of F3, O3, P1~~ — **closed**: `eslint-plugin-cli-floor`, four rules, merged in ofri-peretz/eslint#1137 (464385ff73); its first npm publish is the owner's | burgee F3, O3, P1, D-124 | done |
