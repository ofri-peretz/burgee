...
| A11 | paratext: ansi-escapes 1/4, terminal-link 8/8 (A27), term-img 12/18 — **each at a recorded ceiling**: CSI is out of scope (3 of ansi-escapes' 4), terminal-link's 2 read another package's mutated module object, term-img's 6 pass a PATH where D-030 takes bytes. terminal-link's baseline was stale at 0 and is now 8 | compat baselines | each ceiling restated as a decision, or lifted |
